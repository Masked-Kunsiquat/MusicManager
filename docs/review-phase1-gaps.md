...
**1. EventGenerator has no deduplication**
...
**2. World state evaporates on process restart**
...
**3. Responses aren't logged as events**
...
**4. Double Gemma inference per email read**
...
**7. `GemmaModelConfig` NPU `else` branch returns wrong filename**
...
**8. No unread/read state in the inbox**
...
**9. SHA-256 verification is null**
...
**10. Debug receivers have no build-variant guard**
...
**11. `inFlightOptions` is not thread-safe**
